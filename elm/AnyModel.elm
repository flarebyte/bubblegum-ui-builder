...
basicFieldSupport =
    [ LabelType, HintType, HelpInvalidType, HelpValidType, MinItemsType, MaxItemsType, TraitsType, StylesType, PositionType ]


other =
    [ IconsType, LanguageSyntaxType, MaxLengthType, MaxLinesType, MinLinesType, PlaceholderType, RegularExprType, ValidatorType ]
